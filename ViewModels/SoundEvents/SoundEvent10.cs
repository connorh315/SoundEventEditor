...
{
    public class SoundEvent10 : SoundEventViewModel
    {
        ...
        public SoundEvent10()
        {
            ...
            SEVT_10 evt10 = new SEVT_10();
            evt10.Children.Add(name);

            BuildFromEvent(evt10);
        }

        public SoundEvent10(SEVT_10 evt)
        {
            BuildFromEvent(evt);
        }
    }
